! function() {
  ...
  var t, n = "undefined" != typeof Symbol,
  ...
  if (!t && "undefined" != typeof location) {
    var u = (t = location.href.split("#")[0].split("?")[0]).lastIndexOf("/"); - 1 !== u && (t = t.slice(0, u + 1))
  }
  var c = /\\/g;
        ...
        M = M.then((function() {
          ...
          ! function(t, n, r) {
            ...
            try {
              ...
              var r;
              for (r in e.imports && l(e.imports, n.imports, t, n, null), e.scopes || {}) {
                var i = f(r, t);
  ...
  if (w.prepareImport = function(e) {
      return (L || e) && (I(), L = !1), M
    }, i && (I(), window.addEventListener("DOMContentLoaded", I)), i) {
    window.addEventListener("error", (function(e) {
      A = e.filename, T = e.error
    }));
    var W = location.origin
  }
  w.createScript = function(e) {
    var t = document.createElement("script");
    t.async = !0, e.indexOf(W + "/") && (t.crossOrigin = "anonymous");
    var n = C.integrity[e];
  ...
  w.register = function(e, t) {
    ...
    return new Promise((function(r, o) {
      ...
      s.addEventListener("error", (function() {
        ...
        if (document.head.removeChild(s), A === t) o(T);
        else {
          var e = i.getRegister();
          e && e[0] === P && clearTimeout(R), r(e)
        }
  ...
  w.instantiate = function(e, t) {
      var n = C.depcache[e];
      if (n)
        for (var r = 0; r < n.length; r++) b(this, this.resolve(n[r], e), e);
    ...
    function(e) {
      ...
      i.import = function(i, s) {
        return function() {
          for (var i in t = n = void 0, e) a(i) || (t ? n || (n = i) : t = i, r = i)
        }(), o.call(this, i, s)
      };
      var s = [
          [],
        ...
        return s(t, n).then((function(n) {
          ...
          return r.test(s) ? n.json().then((function(e) {
            ...
            return WebAssembly.Module.imports && WebAssembly.Module.imports(n).forEach((function(e) {
              var t = JSON.stringify(e.module); - 1 === r.indexOf(t) && (r.push(t), i.push("function(m){i[" + t + "]=m}"))
  ...
  w.get = function(e) {
    ...
    var n;
    k && "Module" === t[k] ? n = t : (n = Object.assign(Object.create(null), t), k && Object.defineProperty(n, k, {
      value: "Module"
    }));
